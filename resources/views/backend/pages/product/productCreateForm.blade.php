...
<div class="container">
    ...
    <form action="{{ route('product.submit.form') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="product_details" required class="form-control" placeholder="EnterProduct Details">
        </div>

        <div class="form-group">
            <label for="">Product Price</label>
            <input type="number" min="0" name="product_price" required class="form-control" placeholder="Enter Product Price">
        </div>

        <div class="form-group">
            <label for="">Product Quantity</label>
            <input type="number" name="product_quantity" required class="form-control" placeholder="Enter Product Quantity (Kg/Pics)">
        </div>

        <div class="from-group">
            <label for="">Product Status</label>
            <select name="product_status" required class="from-control" id="">
